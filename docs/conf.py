...
htmlhelp_basename = 'AirTrafficController-NextGenerationdoc'
...
latex_documents = [
  ('index', 'AirTrafficController-NextGeneration.tex', u'Air Traffic Controller - Next Generation Documentation',
   u'Mac Ryan', 'manual'),
]
