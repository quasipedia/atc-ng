...
from lib.utils import blur_image, render_lines, blit_dead_centre
...
class GameCommandsProcessor(object):
    ...
    def __blur_radar(self):
        ...
        use are output for the text generated by the command.
        '''
        orig = self.gamelogic.radar_surface
        self.good_radar_image = orig.copy()
        orig.blit(blur_image(orig, 5), (0, 0))
    ...
    def display(self, text):
        '''
        Display reStructuredText on the radar screen, pausing the game if
        necessary.
        '''
